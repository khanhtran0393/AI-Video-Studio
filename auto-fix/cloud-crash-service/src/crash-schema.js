...
const GIT_SHA_RE = /^[0-9a-fA-F]{40,64}$/;
...
function validateCrashReport(body) {
  ...
  if (body.git_commit_sha !== undefined && body.git_commit_sha !== null
    && (typeof body.git_commit_sha !== 'string' || !GIT_SHA_RE.test(body.git_commit_sha))) {
    errors.push('git_commit_sha must be 40-64 hexadecimal characters');
  }
  if (body.artifact_sha256 !== undefined && body.artifact_sha256 !== null
    && (typeof body.artifact_sha256 !== 'string' || !SHA256_RE.test(body.artifact_sha256))) {
    errors.push('artifact_sha256 must be 64 hexadecimal characters');
  }
