...
const IGNORE = /(?:node_modules|[\\/](?:bundle|dist|out|build-output|coverage|smoke-results)(?:[\\/]|$)|remotion-browser|app\.asar\.unpacked|[\\/](?:\.venv[^\\/]*|venv)(?:[\\/]|$)|[\\/]tdt-studio[\\/](?:app|runtime)(?:[\\/]|$)|[\\/]voice-studio[\\/](?:data|models?)(?:[\\/]|$))/i;
